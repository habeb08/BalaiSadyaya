		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <div class="footer">
	        	<p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved  <i class="icon-heart" aria-hidden="true"></i> by <a href="" target="_blank">T-REX.com</a>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="settings.php">Room Status</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="payment.php">Payment</a>
                </li>
				<li class="nav-item">
                    <a class="nav-link" href="room.php">Add Rooms</a>
                </li>
				<li class="nav-item">
                    <a class="nav-link" href="roomdel.php">Delete Rooms</a>
                </li>
                <li class="nav-item">
