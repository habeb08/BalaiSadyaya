...
<?php
						...
						{	
							...
							if($st=="Conform")
							{
								...
								if($f1=="NO" )
								{
									echo "<script type='text/javascript'> alert('Sorry! Not Available Casita Room ')</script>";
								}
								else if($f2 =="NO")
									{
										echo "<script type='text/javascript'> alert('Sorry! Not Available Dormitory House')</script>";
										
									}
									else if ($f3 == "NO")
									{
										echo "<script type='text/javascript'> alert('Sorry! Not Available Terezza Room')</script>";
									}
										else if($f4=="NO")
										{
											...
											{	
												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
														...
														else if($troom=="Dormitory House")
														{
															$type_of_room = 2500;
														}
														else if($troom=="Regular Room")
														{
															$type_of_room = 2500;
														}
														...
														$psql = "INSERT INTO `payment`(`id`, `fname`, `lname`, `troom`, `tbed`, `nroom`, `cin`, `cout`, `ttot`,`btot`,`fintot`,`noofdays`) VALUES ('$id','$fname','$lname','$troom','$bed','$nroom','$cin','$cout','$ttot','$btot','$fintot','$days')";
